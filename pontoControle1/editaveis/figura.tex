...
\tikzstyle{wa} = [sensor, text width=10em, fill=red!20, 
  ...
  %       	\draw \firstcircle node[below] {$A$};
        ...
        \draw \firstcircle node[below] (a) {$Software$}
        	[clockwise from=30,level distance=170,sibling angle=43]
        ...
        [clockwise from=240,level distance=170,sibling angle=45]
        ...
        [clockwise from=295,level distance=170,sibling angle=45]
